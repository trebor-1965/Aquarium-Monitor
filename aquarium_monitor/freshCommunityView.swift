...
struct freshCommunityView: View {
    ...
    @State private var alkalinity = 0.0
    @State private var phospate = 0.0
...
struct freshCommunityView_Previews: PreviewProvider {
